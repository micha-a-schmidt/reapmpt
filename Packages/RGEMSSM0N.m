...
BeginPackage["REAP`RGEMSSM0N`",{"REAP`RGESymbol`", "REAP`RGESolver`","REAP`RGEUtilities`","REAP`RGETakagi`", "REAP`RGEParameters`","REAP`RGEInitial`","MixingParameterTools`MPT3x3`",
...
RGERegisterModel["MSSM0N","REAP`RGEMSSM0N`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGEYd->`Private`GetYd,RGEMu->`Private`GetMu,RGEY\[Nu]->`Private`GetY\[Nu],RGEMe->`Private`GetMe,RGE\[Kappa]->`Private`Get\[Kappa],RGECoupling->`Private`GetCoupling,RGEM\[Nu]r->`Private`GetM\[Nu]r,RGEAll->`Private`GetSolution,RGEYe->`Private`GetYe,RGEM\[Nu]->`Private`GetM\[Nu],RGEYu->`Private`GetYu,RGEPoleMTop->`Private`GetPoleMTop,RGE\[Alpha]->`Private`Get\[Alpha],RGEMd->`Private`GetMd,RGEMixingParameters->`Private`GetMixingParameters,RGETwistingParameters->`Private`GetTwistingParameters,RGERaw->`Private`GetRawSolution},
{{"MSSM0N",`Private`TransMSSM0N},{"SM",`Private`TransSM},{"MSSM",`Private`TransMSSM},{"2HDM0N",`Private`Trans2HDM0N},{"2HDM",`Private`Trans2HDM},{"SM0N",`Private`TransSM0N}},
        `Private`GetInitial,
...
Begin["`Private`"];
Map[Needs,{"REAP`RGESymbol`", "REAP`RGESolver`","REAP`RGEUtilities`","REAP`RGETakagi`", "REAP`RGEParameters`","REAP`RGEInitial`","MixingParameterTools`MPT3x3`","REAP`RGESM0N`","REAP`RGE2HDM0N`"}];
...
RGEOptions;
Options[RGEOptions]={   
   RGEModelVariant->"1Loop", (* different variation of the model *)
...
ClearAll[RGE2Loop];
RGE2Loop:={	D[g1[t],t]==Betag1[g1[t],g2[t],g3[t],Yu[t],Yd[t],Ye[t],\[Kappa][t]]+Betag12[g1[t],g2[t],g3[t],Yu[t],Yd[t],Ye[t],\[Kappa][t]],
		D[g2[t],t]==Betag2[g1[t],g2[t],g3[t],Yu[t],Yd[t],Ye[t],\[Kappa][t]]+Betag22[g1[t],g2[t],g3[t],Yu[t],Yd[t],Ye[t],\[Kappa][t]],
		D[g3[t],t]==Betag3[g1[t],g2[t],g3[t],Yu[t],Yd[t],Ye[t],\[Kappa][t]]+Betag32[g1[t],g2[t],g3[t],Yu[t],Yd[t],Ye[t],\[Kappa][t]],
...
ClearAll[Betag12, Betag22, Betag32, BetaYu2, BetaYd2, BetaYe2, Beta\[Kappa]2];


(* 2 loop contributions *)
Betag12[g1_,g2_,g3_,Yu_,Yd_,Ye_,\[Kappa]_] := 1/(4*Pi)^4 * With[{
       a = 1,
       g = {g1,g2,g3},
...
Betag22[g1_,g2_,g3_,Yu_,Yd_,Ye_,\[Kappa]_] := 1/(4*Pi)^4 * With[{
       a = 2,
       g = {g1,g2,g3},
       T = { Tr[Yu.Dagger[Yu]], Tr[Yd.Dagger[Yd]], Tr[Ye.Dagger[Ye]] },
       B = {{199/25, 27/5, 88/5}, {9/5, 25, 24}, {11/5, 9, 14}}, 
...
Betag32[g1_,g2_,g3_,Yu_,Yd_,Ye_,\[Kappa]_] := 1/(4*Pi)^4 * With[{
       a = 3,
       g = {g1,g2,g3},
       T = { Tr[Yu.Dagger[Yu]], Tr[Yd.Dagger[Yd]], Tr[Ye.Dagger[Ye]] },
       B = {{199/25, 27/5, 88/5}, {9/5, 25, 24}, {11/5, 9, 14}}, 
...
ClearAll[TransSM0N];
TransSM0N[pScale_?NumericQ,pDirection_?NumericQ,pSolution_,pToOpts_,pFromOpts_]:=Block[{lg1,lg2,lg3,lYu,lYd,lYe,l\[Kappa], lsb,lcb, lDR2MS, lUL,lVL},
...
*)
   ...
   Switch[{RGEModelVariant == "2Loop" /. Options[lFromOpts,RGEModelVariant], RGEModelVariant == "2Loop" /. Options[lToOpts,RGEModelVariant]},
       ...
       lDR2MS = {
           ...
           (1 - lg2^2/(48 Pi^2)),
           (1 - lg3^2/(32 Pi^2)),
           (1 + 1/(32 Pi^2) (-1/36 3/5 lg1^2 - 3/4 lg2^2 + 8/3 lg3^2)),
           (1 + 1/(32 Pi^2) (-13/36 3/5 lg1^2 - 3/4 lg2^2 + 8/3 lg3^2)),
           (1 + 1/(32 Pi^2) (3/4 3/5 lg1^2 - 3/4 lg2^2 ))
       },
       {False, False},
       lDR2MS = {1,1,1,1,1,1},
       _,
       Print["Loop level at SM/MSSM boundary not matching, no \
\!\(\*OverscriptBox[\(DR\), \(_\)]\) to \!\(\*OverscriptBox[\(MS\), \
\(_\)]\) conversion done"];
       lDR2MS = {1,1,1,1,1,1}
   ];
   ...
   lYd = lYd.(IdentityMatrix[3] + (RGE\[CapitalGamma]d/.Options[lFromOpts,RGE\[CapitalGamma]d]));
   lYe = lYe.(IdentityMatrix[3] + (RGE\[CapitalGamma]e/.Options[lFromOpts,RGE\[CapitalGamma]e]));

Return[{
       RGEg1->lg1 lDR2MS[[1]],
       RGEg2->lg2 lDR2MS[[2]],
       RGEg3->lg3 lDR2MS[[3]],
       RGEYu->lYu*lsb lDR2MS[[4]],
       RGEYd->lYd*lcb lDR2MS[[5]],
       RGEYe->lYe*lcb lDR2MS[[6]],
       RGE\[Kappa]->l\[Kappa]*(lsb)^2,
       RGE\[Lambda]->(RGE\[Lambda]/.Options[lToOpts,RGE\[Lambda]])
       }
   ]; (* !!! Parameters !!!*)
];
...
*)
   Return[Join[
       TransSM0N[pScale,pDirection,pSolution,pToOpts,pFromOpts],
       {RGEY\[Nu]->{},RGEM\[Nu]r->{}}
   ]];
];
