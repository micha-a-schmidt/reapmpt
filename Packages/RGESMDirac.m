...
RGERegisterModel["SMDirac","REAP`RGESMDirac`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGEAll->`Private`GetRawSolution,RGEM\[Nu]->`Private`GetM\[Nu],RGEY\[Nu]->`Private`GetY\[Nu],RGE\[Lambda]->`Private`Get\[Lambda],RGEMe->`Private`GetMe,RGEYe->`Private`GetYe,RGEYd->`Private`GetYd,RGEMu->`Private`GetMu,RGEYu->`Private`GetYu,RGEMd->`Private`GetMd,RGECoupling->`Private`GetCoupling,RGE\[Alpha]->`Private`Get\[Alpha],RGERaw->`Private`GetRawSolution,RGEPoleMTop->`Private`GetPoleMTop},
{{"SMDirac",`Private`TransSM},{"MSSMDirac",`Private`TransMSSM}},
        `Private`GetInitial,
