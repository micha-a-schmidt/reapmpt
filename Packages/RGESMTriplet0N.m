...
BeginPackage["REAP`RGESMTriplet0N`",{"REAP`RGESymbol`","REAP`RGESolver`","REAP`RGEUtilities`","REAP`RGETakagi`","REAP`RGEParameters`","REAP`RGEInitial`","MixingParameterTools`MPT3x3`",
...
RGERegisterModel["SMTriplet0N","REAP`RGESMTriplet0N`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGEPoleMTop->`Private`GetPoleMTop,RGE\[Epsilon]1Max->`Private`Get\[Epsilon]1Max,RGEYd->`Private`GetYd,RGEM\[Nu]->`Private`GetM\[Nu],RGETwistingParameters->`Private`GetTwistingParameters,RGEMd->`Private`GetMd,RGEY\[Nu]->`Private`GetY\[Nu],RGEM\[Nu]r->`Private`GetM\[Nu]r,RGEMixingParameters->`Private`GetMixingParameters,RGE\[Alpha]->`Private`Get\[Alpha],RGERawY\[Nu]->`Private`GetRawY\[Nu],RGERaw->`Private`GetRawSolution,RGE\[Epsilon]Max->`Private`Get\[Epsilon]Max,RGERawY\[CapitalDelta]->`Private`GetRawY\[CapitalDelta],RGE\[Epsilon]1->`Private`Get\[Epsilon]1,RGEAll->`Private`GetSolution,RGE\[Kappa]->`Private`Get\[Kappa],RGEMe->`Private`GetMe,RGEMu->`Private`GetMu,RGEYu->`Private`GetYu,RGEYe->`Private`GetYe,RGERawM\[Nu]r->`Private`GetRawM\[Nu]r,RGEM1Tilde->`Private`GetM1Tilde,RGE\[Epsilon]->`Private`Get\[Epsilon],RGE\[Lambda]->`Private`Get\[Lambda],RGEM\[CapitalDelta]2->`Private`GetM\[CapitalDelta]2,RGECoupling->`Private`GetCoupling},
{{"SMTriplet0N",`Private`TransSMTriplet0N},{"SMTriplet",`Private`TransSMTriplet},{"SM0N",`Private`TransSM0N},{"SM",`Private`TransSM}},
        `Private`GetInitial,
...
Begin["`Private`"];
Map[Needs,{"REAP`RGESymbol`","REAP`RGESolver`","REAP`RGEUtilities`","REAP`RGETakagi`","REAP`RGEParameters`","REAP`RGEInitial`","MixingParameterTools`MPT3x3`","REAP`RGESMTriplet`", "REAP`RGESM`", "REAP`RGESM0N`"}];
