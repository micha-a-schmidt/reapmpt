...
(* register 2HDM0N *)
RGERegisterModel["2HDM0N","REAP`RGE2HDM0N`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGE\[Kappa]1->`Private`Get\[Kappa]1,RGEPoleMTop->`Private`GetPoleMTop,RGE\[Alpha]->`Private`Get\[Alpha],RGEYd->`Private`GetYd,RGEMixingParameters->`Private`GetMixingParameters,RGEYu->`Private`GetYu,RGEMe->`Private`GetMe,RGETwistingParameters->`Private`GetTwistingParameters,RGEY\[Nu]->`Private`GetY\[Nu],RGEAll->`Private`GetSolution,RGECoupling->`Private`GetCoupling,RGEYe->`Private`GetYe,RGEMu->`Private`GetMu,RGE\[Lambda]->`Private`Get\[Lambda],RGEM\[Nu]->`Private`GetM\[Nu],RGEM\[Nu]r->`Private`GetM\[Nu]r,RGERaw->`Private`GetRawSolution,RGEMd->`Private`GetMd,RGE\[Kappa]2->`Private`Get\[Kappa]2},
{{"MSSM",`Private`TransMSSM},{"2HDM0N",`Private`Trans2HDM0N},{"MSSM0N",`Private`TransMSSM0N}},
        `Private`GetInitial,
...
(* GetRawM\[Nu]r is not a function of 2HDM0N *)
(* GetRawY\[Nu] is not a function of 2HDM0N *)
...
(* GetM\[CapitalDelta]2 is not a function of 2HDM0N *)
(* GetM\[CapitalDelta] is not a function of 2HDM0N *)
ClearAll[GetYe];
...
(* GetRawY\[CapitalDelta] is not a function of 2HDM0N *)
ClearAll[GetY\[Nu]];
...
(* Get\[Kappa] is not a function of 2HDM0N *)
...
(* GetM1Tilde is not a function of 2HDM0N *)
(* Get\[Epsilon]1Max is not a function of 2HDM0N *)
(* Get\[Epsilon]1 is not a function of 2HDM0N *)
(* GetGWCond is not a function of 2HDM0N *)
(* GetGWConditions is not a function of 2HDM0N *)
(* GetVEVratio is not a function of 2HDM0N *)
(* GetVEVratios is not a function of 2HDM0N *)
ClearAll[Dagger];
