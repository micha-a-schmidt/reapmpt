...
BeginPackage["REAP`RGESMTriplet`",{"REAP`RGESymbol`","REAP`RGESolver`","REAP`RGEUtilities`","REAP`RGETakagi`","REAP`RGEParameters`","REAP`RGEInitial`","MixingParameterTools`MPT3x3`",
...
RGERegisterModel["SMTriplet","REAP`RGESMTriplet`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGE\[Lambda]->`Private`Get\[Lambda],RGE\[Kappa]->`Private`Get\[Kappa],RGEMd->`Private`GetMd,RGETwistingParameters->`Private`GetTwistingParameters,RGEYd->`Private`GetYd,RGE\[Epsilon]1Max->`Private`Get\[Epsilon]1Max,RGEMixingParameters->`Private`GetMixingParameters,RGEM\[Nu]r->`Private`GetM\[Nu]r,RGERawY\[CapitalDelta]->`Private`GetRawY\[CapitalDelta],RGERaw->`Private`GetRawSolution,RGECoupling->`Private`GetCoupling,RGEM\[Nu]->`Private`GetM\[Nu],RGEM\[CapitalDelta]2->`Private`GetM\[CapitalDelta]2,RGE\[Alpha]->`Private`Get\[Alpha],RGEM1Tilde->`Private`GetM1Tilde,RGEY\[Nu]->`Private`GetY\[Nu],RGE\[Epsilon]->`Private`Get\[Epsilon],RGERawM\[Nu]r->`Private`GetRawM\[Nu]r,RGEMe->`Private`GetMe,RGEYe->`Private`GetYe,RGE\[Epsilon]Max->`Private`Get\[Epsilon]Max,RGE\[Epsilon]1->`Private`Get\[Epsilon]1,RGEMu->`Private`GetMu,RGEYu->`Private`GetYu,RGERawY\[Nu]->`Private`GetRawY\[Nu],RGEAll->`Private`GetSolution,RGEPoleMTop->`Private`GetPoleMTop},
{{"SM0N",`Private`TransSM0N},{"SM",`Private`TransSM},{"SMTriplet",`Private`TransSMTriplet},{"SMTriplet0N",`Private`TransSMTriplet0N}},
        `Private`GetInitial,
...
Begin["`Private`"];
Map[Needs,{"REAP`RGESymbol`","REAP`RGESolver`","REAP`RGEUtilities`","REAP`RGETakagi`","REAP`RGEParameters`","REAP`RGEInitial`","MixingParameterTools`MPT3x3`","REAP`RGESMTriplet0N`", "REAP`RGESM`", "REAP`RGESM0N`" }];
...
ParameterSymbols={RGEg1,RGEg2,RGEg3,RGEYu,RGEYd,RGEYe,RGEY\[Nu],RGEY\[CapitalDelta],RGE\[Kappa],RGEM\[Nu]r,RGE\[Lambda],RGE\[CapitalLambda]1,RGE\[CapitalLambda]2,RGE\[CapitalLambda]4,RGE\[CapitalLambda]5,RGE\[CapitalLambda]6, RGEM\[CapitalDelta]2};
...
{"GUT",{
	...
	RGEM\[Nu]r->RGEGetM[RGE\[Theta]12,RGE\[Theta]13,RGE\[Theta]23,RGE\[Delta],RGE\[Delta]e,RGE\[Delta]\[Mu],RGE\[Delta]\[Tau],RGE\[CurlyPhi]1,RGE\[CurlyPhi]2,RGEMlightest,RGE\[CapitalDelta]m2atm,RGE\[CapitalDelta]m2sol,RGEMassHierarchy,RGEvu,RGEY\[Nu],RGE\[Kappa],RGEY\[CapitalDelta],RGE\[CapitalLambda]6,RGEM\[CapitalDelta]2],
...
Beta\[CapitalLambda]4[g1_,g2_,g3_,Yu_,Yd_,Ye_,Y\[Nu]_,Y\[CapitalDelta]_,\[Kappa]_,M\[Nu]r_,\[Lambda]_,\[CapitalLambda]1_,\[CapitalLambda]2_,\[CapitalLambda]4_,\[CapitalLambda]5_,\[CapitalLambda]6_,M\[CapitalDelta]2_] := 1/(16*Pi^2) * (
    ...
    -4 * Tr[Dagger[Y\[CapitalDelta]].Y\[CapitalDelta].Dagger[Ye].Ye]
    );
...
Beta\[CapitalLambda]6[g1_,g2_,g3_,Yu_,Yd_,Ye_,Y\[Nu]_,Y\[CapitalDelta]_,\[Kappa]_,M\[Nu]r_,\[Lambda]_,\[CapitalLambda]1_,\[CapitalLambda]2_,\[CapitalLambda]4_,\[CapitalLambda]5_,\[CapitalLambda]6_,M\[CapitalDelta]2_] := 1/(16*Pi^2) * (
    ...
    + 4 * Tr[Dagger[Y\[CapitalDelta]].Transpose[Y\[Nu]].M\[Nu]r.Y\[Nu]]
    );
...
BetaM\[CapitalDelta]2[g1_,g2_,g3_,Yu_,Yd_,Ye_,Y\[Nu]_,Y\[CapitalDelta]_,\[Kappa]_,M\[Nu]r_,\[Lambda]_,\[CapitalLambda]1_,\[CapitalLambda]2_,\[CapitalLambda]4_,\[CapitalLambda]5_,\[CapitalLambda]6_,M\[CapitalDelta]2_] := 1/(16*Pi^2) * (
    ...
    - \[CapitalLambda]4 * \[Lambda] * RGEvu^2
    + 2* \[CapitalLambda]6*Conjugate[\[CapitalLambda]6]
    );

(* 4 \[CapitalLambda]4 m^2 replaced by - \[CapitalLambda]4*\[Lambda] v^2  using 4 m^2 = -\[Lambda] v^2 from definition of VEV *)
...
(* calculate the new parameters *)
	...
	If[lToIntegratedOut>lFromIntegratedOut,
        ...
        Return[{RGEg1->lg1,RGEg2->lg2,RGEg3->lg3,RGEYu->lYu,RGEYd->lYd,RGEYe->lYe,RGEY\[Nu]->lY\[Nu],RGEY\[CapitalDelta]->lY\[CapitalDelta],RGE\[Kappa]->l\[Kappa],RGEM\[Nu]r->lM\[Nu]r,RGE\[Lambda]->l\[Lambda],RGE\[CapitalLambda]1->l\[CapitalLambda]1,RGE\[CapitalLambda]2->l\[CapitalLambda]2,RGE\[CapitalLambda]4->l\[CapitalLambda]4,RGE\[CapitalLambda]5->l\[CapitalLambda]5,RGE\[CapitalLambda]6->l\[CapitalLambda]6,RGEM\[CapitalDelta]2->lM\[CapitalDelta]2}];
];
