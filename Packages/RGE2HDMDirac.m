...
RGERegisterModel["2HDMDirac","REAP`RGE2HDMDirac`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGEY\[Nu]->`Private`GetY\[Nu],RGE\[Alpha]->`Private`Get\[Alpha],RGEMe->`Private`GetMe,RGEMd->`Private`GetMd,RGEPoleMTop->`Private`GetPoleMTop,RGEYu->`Private`GetYu,RGEYd->`Private`GetYd,RGEAll->`Private`GetRawSolution,RGEMu->`Private`GetMu,RGERaw->`Private`GetRawSolution,RGEM\[Nu]->`Private`GetM\[Nu],RGEYe->`Private`GetYe,RGECoupling->`Private`GetCoupling,RGE\[Lambda]->`Private`Get\[Lambda]},
{{"MSSMDirac",`Private`TransMSSM},{"2HDMDirac",`Private`Trans2HDM}},
        `Private`GetInitial,
