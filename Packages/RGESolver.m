...
BeginPackage["REAP`RGESolver`",{"REAP`RGEUtilities`","REAP`RGETakagi`","REAP`RGESymbol`"}];

Print["Loading REAP 1.11.5
"];
...
the boundary scale and the range used to solve the RGE.";
 ...
 Map[Needs,{"REAP`RGEUtilities`","REAP`RGETakagi`","REAP`RGESymbol`"}];
