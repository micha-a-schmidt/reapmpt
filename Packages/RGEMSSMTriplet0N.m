...
RGERegisterModel["MSSMTriplet0N","REAP`RGEMSSMTriplet0N`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGEMd->`Private`GetMd,RGEMe->`Private`GetMe,RGE\[Kappa]->`Private`Get\[Kappa],RGE\[Alpha]->`Private`Get\[Alpha],RGEM\[CapitalDelta]->`Private`GetM\[CapitalDelta],RGEYe->`Private`GetYe,RGEYd->`Private`GetYd,RGETwistingParameters->`Private`GetTwistingParameters,RGEM\[Nu]r->`Private`GetM\[Nu]r,RGEMixingParameters->`Private`GetMixingParameters,RGEYu->`Private`GetYu,RGEM\[Nu]->`Private`GetM\[Nu],RGEY\[Nu]->`Private`GetY\[Nu],RGEMu->`Private`GetMu,RGECoupling->`Private`GetCoupling,RGERawY\[CapitalDelta]->`Private`GetRawY\[CapitalDelta],RGEAll->`Private`GetSolution,RGEPoleMTop->`Private`GetPoleMTop,RGERaw->`Private`GetRawSolution},
{{"SM0N",`Private`TransSM0N},{"MSSMTriplet0N",`Private`TransMSSMTriplet0N},{"SMTriplet",`Private`TransSMTriplet},{"2HDM0N",`Private`Trans2HDM0N},{"MSSM0N",`Private`TransMSSM0N},{"SMTriplet0N",`Private`TransSMTriplet0N},{"2HDM",`Private`Trans2HDM},{"SM",`Private`TransSM},{"MSSM",`Private`TransMSSM},{"MSSMTriplet",`Private`TransMSSMTriplet}},
        `Private`GetInitial,
