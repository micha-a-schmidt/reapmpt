...
BeginPackage["REAP`RGEMSSMTriplet`",{"REAP`RGESymbol`", "REAP`RGESolver`","REAP`RGEUtilities`","REAP`RGETakagi`", "REAP`RGEParameters`","REAP`RGEInitial`","MixingParameterTools`MPT3x3`",
...
RGERegisterModel["MSSMTriplet","REAP`RGEMSSMTriplet`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGEYd->`Private`GetYd,RGE\[Epsilon]1->`Private`Get\[Epsilon]1,RGEMd->`Private`GetMd,RGEM\[CapitalDelta]->`Private`GetM\[CapitalDelta],RGE\[Alpha]->`Private`Get\[Alpha],RGERaw->`Private`GetRawSolution,RGERawY\[Nu]->`Private`GetRawY\[Nu],RGE\[Epsilon]->`Private`Get\[Epsilon],RGE\[Kappa]->`Private`Get\[Kappa],RGEM1Tilde->`Private`GetM1Tilde,RGECoupling->`Private`GetCoupling,RGE\[Epsilon]1Max->`Private`Get\[Epsilon]1Max,RGETwistingParameters->`Private`GetTwistingParameters,RGEAll->`Private`GetSolution,RGEMixingParameters->`Private`GetMixingParameters,RGEY\[Nu]->`Private`GetY\[Nu],RGEM\[Nu]->`Private`GetM\[Nu],RGEMu->`Private`GetMu,RGEYu->`Private`GetYu,RGEYe->`Private`GetYe,RGEM\[Nu]r->`Private`GetM\[Nu]r,RGEMe->`Private`GetMe,RGERawM\[Nu]r->`Private`GetRawM\[Nu]r,RGEPoleMTop->`Private`GetPoleMTop,RGERawY\[CapitalDelta]->`Private`GetRawY\[CapitalDelta],RGE\[Epsilon]Max->`Private`Get\[Epsilon]Max},
{{"2HDM",`Private`Trans2HDM},{"MSSM0N",`Private`TransMSSM0N},{"MSSMTriplet0N",`Private`TransMSSMTriplet0N},{"MSSMTriplet",`Private`TransMSSMTriplet},{"MSSM",`Private`TransMSSM},{"2HDM0N",`Private`Trans2HDM0N},{"SMTriplet",`Private`TransSMTriplet},{"SM",`Private`TransSM},{"SM0N",`Private`TransSM0N},{"SM0NTriplet",`Private`TransSMTriplet0N}},
        `Private`GetInitial,
...
Begin["`Private`"];
Map[Needs,{"REAP`RGESymbol`", "REAP`RGESolver`","REAP`RGEUtilities`","REAP`RGETakagi`", "REAP`RGEParameters`","REAP`RGEInitial`","MixingParameterTools`MPT3x3`","REAP`RGEMSSM`","REAP`RGESM`","REAP`RGEMSSM0N`","REAP`RGESM0N`","REAP`RGE2HDM`","REAP`RGE2HDM0N`", "REAP`RGESMTriplet`","REAP`RGEMSSMTriplet0N`","REAP`RGESMTriplet0N`"}];
