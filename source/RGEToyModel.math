...
BeginPackage["REAP`RGEToyModel`",{"REAP`RGESolver`","REAP`RGESymbol`","REAP`RGEUtilities`","REAP`RGETakagi`"}];
...
Begin["`Private`"];
Map[Needs,{"REAP`RGESolver`","REAP`RGESymbol`","REAP`RGEUtilities`","REAP`RGETakagi`"}];
