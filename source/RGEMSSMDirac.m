...
BeginPackage["REAP`RGEMSSMDirac`",{"REAP`RGESymbol`", "REAP`RGESolver`","REAP`RGEUtilities`","REAP`RGETakagi`", "REAP`RGEParameters`","REAP`RGEInitial`","MixingParameterTools`MPT3x3`",
...
RGERegisterModel["MSSMDirac","REAP`RGEMSSMDirac`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGEYe->`Private`GetYe,RGERaw->`Private`GetRawSolution,RGEMd->`Private`GetMd,RGEM\[Nu]->`Private`GetM\[Nu],RGEMu->`Private`GetMu,RGE\[Alpha]->`Private`Get\[Alpha],RGEAll->`Private`GetRawSolution,RGEMe->`Private`GetMe,RGEY\[Nu]->`Private`GetY\[Nu],RGEPoleMTop->`Private`GetPoleMTop,RGEYd->`Private`GetYd,RGEYu->`Private`GetYu,RGECoupling->`Private`GetCoupling},
{{"2HDMDirac",`Private`Trans2HDM},{"SMDirac",`Private`TransSM},{"MSSMDirac",`Private`TransMSSM}},
        `Private`GetInitial,
...
Begin["`Private`"];
Map[Needs,{"REAP`RGESymbol`", "REAP`RGESolver`","REAP`RGEUtilities`","REAP`RGETakagi`", "REAP`RGEParameters`","REAP`RGEInitial`","MixingParameterTools`MPT3x3`","REAP`RGESMDirac`","REAP`RGE2HDMDirac`"}];
