...
RGERegisterModel["MSSM","REAP`RGEMSSM`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGERawY\[Nu]->`Private`GetRawY\[Nu],RGEY\[Nu]->`Private`GetY\[Nu],RGEAll->`Private`GetSolution,RGEYe->`Private`GetYe,RGEPoleMTop->`Private`GetPoleMTop,RGEMu->`Private`GetMu,RGERaw->`Private`GetRawSolution,RGEMd->`Private`GetMd,RGETwistingParameters->`Private`GetTwistingParameters,RGECoupling->`Private`GetCoupling,RGEM\[Nu]r->`Private`GetM\[Nu]r,RGE\[Alpha]->`Private`Get\[Alpha],RGERawM\[Nu]r->`Private`GetRawM\[Nu]r,RGEMixingParameters->`Private`GetMixingParameters,RGEM1Tilde->`Private`GetM1Tilde,RGEM\[Nu]->`Private`GetM\[Nu],RGEMe->`Private`GetMe,RGEYu->`Private`GetYu,RGEYd->`Private`GetYd,RGE\[Kappa]->`Private`Get\[Kappa],RGE\[Epsilon]1Max->`Private`Get\[Epsilon]1Max,RGE\[Epsilon]->`Private`Get\[Epsilon],RGE\[Epsilon]1->`Private`Get\[Epsilon]1,RGE\[Epsilon]Max->`Private`Get\[Epsilon]Max},
{{"MSSM",`Private`TransMSSM},{"MSSM0N",`Private`TransMSSM0N},{"SM0N",`Private`TransSM0N},{"2HDM",`Private`Trans2HDM},{"SM",`Private`TransSM},{"2HDM0N",`Private`Trans2HDM0N}},
        `Private`GetInitial,
