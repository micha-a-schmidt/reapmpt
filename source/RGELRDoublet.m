...
BeginPackage["REAP`RGELRDoublet`",{"REAP`RGESymbol`","REAP`RGESolver`","REAP`RGEParameters`","REAP`RGEUtilities`","REAP`RGETakagi`","MixingParameterTools`MPT3x3`","REAP`RGEInitial`","REAP`RGE2HDMDirac`"}];
...
RGERegisterModel["LRDoublet","REAP`RGELRDoublet`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGEVEVratio->`Private`GetVEVratio,RGE\[Alpha]->`Private`Get\[Alpha],RGEGWCondition->`Private`GetGWCond,RGEGWConditions->`Private`GetGWConditions,RGEAll->`Private`GetRawSolution,RGECoupling->`Private`GetCoupling,RGEVEVratios->`Private`GetVEVratios},
...
Begin["`Private`"];
Map[Needs,{"REAP`RGESymbol`","REAP`RGESolver`","REAP`RGEParameters`","REAP`RGEUtilities`","REAP`RGETakagi`","MixingParameterTools`MPT3x3`","REAP`RGEInitial`","REAP`RGE2HDMDirac`"}];
